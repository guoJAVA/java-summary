...
![任务的执行相关接口](../../../media/pictures/java/multithread/任务的执行相关接口.png)
...
![微信截图_20200802202700](../../../media/pictures/java/multithread/微信截图_20200802202700.png)
...
![线程池各个参数的关系](../../../media/pictures/java/multithread/线程池各个参数的关系.jpg)
...
![ThreadPoolExecutor构造方法](../../../media/pictures/java/multithread/ThreadPoolExecutor构造方法.png)
...
![图解线程池实现原理](../../../media/pictures/java/multithread/图解线程池实现原理.png)
...
![微信截图_20200802223728](../../../media/pictures/java/multithread/微信截图_20200802223728.png)
...
![微信截图_20200802224826](../../../media/pictures/java/multithread/微信截图_20200802224826.png)
...
![微信截图_20200803134155](../../../media/pictures/java/multithread/微信截图_20200803134155.png)
...
### 六、ScheduledThreadPoolExecutor详解

**`ScheduledThreadPoolExecutor` 主要用来在给定的延迟后运行任务，或者定期执行任务。** 这个在实际项目中基本不会被用到，因为有其他方案选择比如`quartz`。大家只需要简单了解一下它的思想。关于如何在 Spring Boot 中 实现定时任务，可以查看这篇文章[《5 分钟搞懂如何在 Spring Boot 中 Schedule Tasks》](docs/Java/SpringBoot/SpringBoot-ScheduleTasks.md)。
...
![微信截图_20200804133219](../../../media/pictures/java/multithread/微信截图_20200804133219.png)
...
![微信截图_20200804135536](../../../media/pictures/java/multithread/微信截图_20200804135536.png)
...
**如果我们设置的线程池数量太小的话，如果同一时间有大量任务/请求需要处理，可能会导致大量的请求/任务在任务队列中排队等待执行，甚至会出现任务队列满了之后任务/请求无法处理的情况，或者大量任务堆积在任务队列导致 OOM(即OutOfMemory,内存溢出)。这样很明显是有问题的！ CPU 根本没有得到充分利用。**
