...
![jdk1.8之前的内部结构](../../../media/pictures/java/collection/jdk1.8之前的内部结构.png)

**JDK1.8之后**

相比于之前的版本，jdk1.8在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

![67233764](../../../media/pictures/java/collection/67233764.jpg)
...
ps:下图有一个小问题：直接覆盖之后应该就会 return，不会有后续操作。参考 JDK8 HashMap.java 658 行。

![put方法](../../../media/pictures/java/collection/put方法.png)
