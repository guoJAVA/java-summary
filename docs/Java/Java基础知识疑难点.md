...
![BigDecimal](../../media/pictures/java/BigDecimal.png)
...
### 2.3.不要在foreach循环里进行元素的remove/add操作
...
![foreach-remove_add](../../media/pictures/java/foreach-remove_add.png)