...
![JVM运行时数据区域](../../../media/pictures/java/JVM/JVM运行时数据区域.png)

**JDK 1.8 ：**

![2019-3Java运行时数据区域JDK1.8](../../../media/pictures/java/JVM/2019-3Java运行时数据区域JDK1.8.png)
...
![image-20200824142013721](../../../media/pictures/java/JVM/image-20200824142013721.png)

JDK 8 版本之后方法区（HotSpot 的永久代）被彻底移除了（JDK1.7 就已经开始了），取而代之是元空间，元空间使用的是直接内存。

![image-20200824142056267](../../../media/pictures/java/JVM/image-20200824142056267.png)
...
![image-20200824145815209](../../../media/pictures/java/JVM/image-20200824145815209.png)
...
![内存分配的两种方式](../../../media/pictures/java/JVM/内存分配的两种方式.png)
...
2. **直接指针：**  如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而 reference 中存储的直接就是对象的地址。
   ![对象的访问定位-直接指针](../../../media/pictures/java/JVM/对象的访问定位-直接指针.png)
...
![2019-3String-Pool-Java1-450x249](../../../media/pictures/java/JVM/2019-3String-Pool-Java1-450x249.png)
...
![字符串拼接-常量池2](../../../media/pictures/java/JVM/字符串拼接-常量池2.png)
