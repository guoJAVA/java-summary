...
![desktop类文件结构概览](../../../media/pictures/java/JVM/desktop类文件结构概览.png)
...
![类文件字节码结构组织示意图](../../../media/pictures/java/JVM/类文件字节码结构组织示意图.png)
...
![访问标志](../../../media/pictures/java/JVM/访问标志.png)
...
![查看类的访问标志](../../../media/pictures/java/JVM/查看类的访问标志.png)
...
![字段表的结构](../../../media/pictures/java/JVM/字段表的结构.png)
...
![字段的access_flags的取值](../../../media/pictures/java/JVM/字段的access_flags的取值.png)
...
![方法表的结构](../../../media/pictures/java/JVM/方法表的结构.png)

**方法表的 access_flag 取值：**

![方法表的access_flag的所有标志位](../../../media/pictures/java/JVM/方法表的access_flag的所有标志位.png)
