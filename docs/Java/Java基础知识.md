...
6支持多线程（C++语言没有内置的多线程机制，因此必须调用操作系统的多线程功能来进行多线程程序设计，而Java语言却提供了多线程支持）；
...
##### 1.1.5.1.JVM：java虚拟机（加载.class并运行.class）
...
![Java 程序运行过程](../../media/pictures/java/Java 程序运行过程.png)
...
##### 1.1.5.2.JRE：java运行环境(*运行*java程序的*最小环境*)

除了包含JVM以外还包含运行java所必须的环境
	     JRE=JVM+java系统类库

##### 1.1.5.3.JDK：java开发工具包(*开发*java程序的*最小环境*)
...
#### 1.1.7.Oracle JDK 和 OpenJDK 的对比
...
> java 编程思想第四版：2.2.2 节![86735519](../../media/pictures/java/86735519.jpg)
...
##### 1.2.9.3.为什么重写`equals`时必须重写`hashCode`方法

如果两个对象相等，则 hashcode 一定也是相同的。两个对象相等,对两个对象分别调用 equals 方法都返回 true。但是，两个对象有相同的 hashcode 值，它们也不一定是相等的 。**因此，equals 方法被覆盖过，则 `hashCode` 方法也必须被覆盖。**

> `hashCode()`的默认行为是对堆上的对象产生独特值。如果没有重写 `hashCode()`，则该 class 的两个对象无论如何都不会相等（即使这两个对象指向相同的数据）

##### 1.2.9.4.为什么两个对象有相同的hashcode值，它们也不一定是相等的?
...
##### 1.2.9.5.hashCode（）与equals（）的相关规定
...
![22191348](../../media/pictures/java/22191348.jpg)
...
![3825204](../../media/pictures/java/3825204.jpg)
...
![88729818](../../media/pictures/java/88729818.jpg)

交换之后：

![34384414](../../media/pictures/java/34384414.jpg)
...
![desktopjava核心技术-重载](../../media/pictures/java/desktopjava核心技术-重载.jpg)
...
[详见](/docs/Java/basic/final,static,this,super.md)
...
#### 2.5.4.Java序列化中如果有些字段不想进行序列化，怎么办？
...
[详情](/docs/Java/basic/collections.md)

### 3.2.异常

#### 3.2.1.Java异常类层次结构图

![199703ce-a1b6-4968-9eb0-161a8217507e](../../media/pictures/java/199703ce-a1b6-4968-9eb0-161a8217507e.png)

![3c45529f-8915-448b-816a-360f8cb73fc7](../../media/pictures/java/3c45529f-8915-448b-816a-360f8cb73fc7.png)
...
![Java 线程状态变迁](../../media/pictures/java/Java 线程状态变迁.png)
