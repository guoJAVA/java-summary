...
![image-20200729213747593](../../media/pictures/java/multithread/image-20200729213747593.png)
...
![image-20200729225520736](../../media/pictures/java/multithread/image-20200729225520736.png)
...
![image-20200730075812065](../../media/pictures/java/multithread/image-20200730075812065.png)
...
![image-20200730080932447](../../media/pictures/java/multithread/image-20200730080932447.png)
...
1. **句柄：** 如果使用句柄的话，那么Java堆中将会划分出一块内存来作为句柄池，reference 中存储的就是对象的句柄地址，而句柄中包含了对象实例数据与类型数据各自的具体地址信息；
   ![image-20200730083319443](../../media/pictures/java/multithread/image-20200730083319443.png)
2. **直接指针：** 如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而reference 中存储的直接就是对象的地址。
   ![image-20200730083507940](../../media/pictures/java/multithread/image-20200730083507940.png)
...
![image-20200730084047665](../../media/pictures/java/multithread/image-20200730084047665.png)

记住：**只要使用new方法，便需要创建新的对象。**

##### 4.1.2.String类型的常量池

该类型的常量池比较特殊，它的主要使用方法有两种：
...
![image-20200730130750938](../../media/pictures/java/multithread/image-20200730130750938.png)
